...
@if exist .\Lib\%makefile_lib_linux%          del .\Lib\%makefile_lib_linux%
@if exist .\Lib_UT\%makefile_lib_ut_windows%  del .\Lib_UT\%makefile_lib_ut_windows%
@if exist .\Lib_UT\%makefile_lib_ut_linux%    del .\Lib_UT\%makefile_lib_ut_linux%
...
%tool_path% --verbose -in Lib/Lib.cbp       -makefile "debug,release,all" -out Lib/%makefile_lib_linux%   -unix
:Lib_UT
%tool_path% --verbose -in Lib_UT/Lib_UT.cbp -makefile "debug,release,all" -out Lib_UT/%makefile_lib_ut_windows% -windows
%tool_path% --verbose -in Lib_UT/Lib_UT.cbp -makefile "debug,release,all" -out Lib_UT/%makefile_lib_ut_linux%   -unix
