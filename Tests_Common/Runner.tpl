...
int main( int argc, char *argv[] )
{
    ...
    auto customSink = std::make_unique<g3::CustomFileSink>("UT_Tests_Common_Log.txt", g3::CustomFileSink::FlushMode::AutoBackground, logFormatter);
    customSink->Clear();
    ...
    // ---------------- Start UT framework
    //
    CxxTest::RealWorldDescription::_worldName = "Mast_Tests_Common";
