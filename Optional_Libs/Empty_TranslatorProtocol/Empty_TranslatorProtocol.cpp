...
// Project : Mast
//
//! @file Empty_TranslatorProtocol.cpp
//!
//! Implements class Empty_TranslatorProtocol, which can be used as a model
...
//!
Empty_TranslatorProtocol::Empty_TranslatorProtocol ()
{
}
//
//  End of: Empty_TranslatorProtocol::Empty_TranslatorProtocol
//---------------------------------------------------------------------------
...
//
//  End of: Empty_TranslatorProtocol::TransformationCallback
//---------------------------------------------------------------------------


//===========================================================================
// End of Empty_TranslatorProtocol.cpp
//===========================================================================
