...
CMAKE_DEBUG_FLAGS         =  -DCMAKE_BUILD_TYPE=Debug   $(CMAKE_FLAGS) $(CPP_DEFINES)  -DINSTALL_ARM:BOOL=OFF
CMAKE_RELEASE_FLAGS       =  -DCMAKE_BUILD_TYPE=Release $(CMAKE_FLAGS) $(CPP_DEFINES)  -DINSTALL_ARM:BOOL=OFF
CMAKE_CODE_COVERAGE_FLAGS = $(CMAKE_DEBUG_FLAGS) -DCODE_COVERAGE:BOOL=ON   -DINSTALL_ARM:BOOL=OFF

CMAKE_CENTOS_FLAGS =  -DCMAKE_BUILD_TYPE=Debug   $(CMAKE_FLAGS)   -DINSTALL_ARM:BOOL=OFF
