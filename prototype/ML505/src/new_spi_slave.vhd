...
ARCHITECTURE logic OF new_spi_slave IS
  ...
  WITH mode SELECT
    ...
    fifo_mosi : jtag_to_lcd_fifo
      PORT map (
        ...
        wr_clk => sclk,
        rd_clk => clk_driver,
        din => fifo_mosi_data_in,
        wr_en => fifo_mosi_we,
        rd_en => fifo_mosi_re,
        dout => fifo_mosi_data_out,
        full => open,
        empty => fifo_mosi_empty
      );
    ...
    fifo_miso : jtag_to_lcd_fifo
      PORT map (
        ...
        wr_clk => clk_driver,
        rd_clk => sclk,
        din => fifo_miso_data_in,
        wr_en => fifo_miso_we,
        rd_en => fifo_miso_re,
        dout => fifo_miso_data_out,
        full => open,
        empty => fifo_miso_empty
      );
