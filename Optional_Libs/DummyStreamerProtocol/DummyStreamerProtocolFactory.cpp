//===========================================================================
//                           DummyStreamerProtocolFactory.cpp
//===========================================================================
// Copyright (C) 2020 G-INP/Tima. All rights reserved.
//
// Project : Mast
//
//! @file DummyStreamerProtocolFactory.cpp
//!
//! Implements class DummyStreamerProtocolFactory
//!
//===========================================================================
...
namespace
{
  ...
  bool StreamerProtocolFactory ()
  {
    ...
    { return std::make_unique<DummyStreamerProtocol>( parameters); };
