...
namespace g3 {
   namespace internal {
      ...
      std::map<int, atomicbool> g_log_level_status = {{g3::kDebugValue, true}, {INFO.value, true}, {WARNING.value, true}, {ERROR_LVL.value, true}, {FATAL.value, true}};
#endif
   } // internal
   ...
   {
     void setLogLevel(const LEVELS& log_level, bool enabled) {
     ...
     void reset() {
        ...
        internal::g_log_level_status = {{g3::kDebugValue, true}, {INFO.value, true}, {WARNING.value, true}, {FATAL.value, true}};
     }
