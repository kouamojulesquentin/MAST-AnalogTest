...
void UT_GmlPrinterVisitor::test_VisitAccessInterface_with_Child ()
{
  ...
  auto expected = string("graph\n"
                         "[\n"
                         "   hierarchic 1 directed 1\n"
                         "   node [ id 9 graphics [ type \"octagon\" fill \"#10FFFF\" w 189 h 63 ] LabelGraphics [ text \"Access interface name\" fontSize 13 fontStyle \"bold\" ] ]\n"
                         "   node [ id 0 graphics [ type \"ellipse\" fill \"#AA55AA\" w 72 h 35 ] LabelGraphics [ text \"Tap name\" fontSize 13 fontStyle \"bold\" ] ]\n"
                         "   edge [ source 9 target 0 label \"1\" ]\n"
                         "   node [ id 1 graphics [ type \"ellipse\" fill \"#FFCC20\" w 90 h 35 ] LabelGraphics [ text \"Chain name\" fontSize 13 fontStyle \"bold\" ] ]\n"
                         "   node [ id 2 graphics [ type \"rectangle\" fill \"#59FF20\" w 50 h 35 ] LabelGraphics [ text \"Reg_1\" fontSize 13 fontStyle \"bold\" ] ]\n"
                         "   edge [ source 1 target 2 label \"1\" ]\n"
                         "   node [ id 3 graphics [ type \"rectangle\" fill \"#59FF20\" w 50 h 35 ] LabelGraphics [ text \"Reg_2\" fontSize 13 fontStyle \"bold\" ] ]\n"
                         "   edge [ source 1 target 3 label \"2\" ]\n"
                         "   node [ id 4 graphics [ type \"rectangle\" fill \"#59FF20\" w 50 h 35 ] LabelGraphics [ text \"Reg_3\" fontSize 13 fontStyle \"bold\" ] ]\n"
                         "   edge [ source 1 target 4 label \"3\" ]\n"
                         "   edge [ source 9 target 1 label \"2\" ]\n"
                         "   node [ id 8 graphics [ type \"ellipse\" fill \"#FF3060\" w 99 h 35 ] LabelGraphics [ text \"Linker name\" fontSize 13 fontStyle \"bold\" ] ]\n"
                         ...
                         "   node [ id 6 graphics [ type \"rectangle\" fill \"#59FF20\" w 108 h 36 ] LabelGraphics [ text \"the register\" fontSize 13 fontStyle \"bold\" ] ]\n"
...
void UT_GmlPrinterVisitor::test_Visit_After_GetGraph ()
{
  ...
  auto expected = string("graph\n"
                         "[\n"
                         "   hierarchic 1 directed 1\n"
                         "   node [ id 3 graphics [ type \"octagon\" fill \"#10FFFF\" w 54 h 35 ] LabelGraphics [ text \"Access\" fontSize 13 fontStyle \"bold\" ] ]\n"
                         "   node [ id 0 graphics [ type \"ellipse\" fill \"#FFCC20\" w 50 h 35 ] LabelGraphics [ text \"Chain\" fontSize 13 fontStyle \"bold\" ] ]\n"
                         "   node [ id 1 graphics [ type \"rectangle\" fill \"#59FF20\" w 50 h 35 ] LabelGraphics [ text \"Reg_1\" fontSize 13 fontStyle \"bold\" ] ]\n"
                         "   edge [ source 0 target 1 label \"1\" ]\n"
                         "   node [ id 2 graphics [ type \"rectangle\" fill \"#59FF20\" w 50 h 35 ] LabelGraphics [ text \"Reg_2\" fontSize 13 fontStyle \"bold\" ] ]\n"
