...
CMAKE_DEBUG_FLAGS=    -DCMAKE_BUILD_TYPE=Debug   $(CMAKE_FLAGS) -DUSE_OPEN_OCD:BOOL=$(USE_OPEN_OCD) -DUSE_LIBFTDISPI:BOOL=ON -DBUILD_UT:BOOL=$(BUILD_UT)
CMAKE_RELEASE_FLAGS=  -DCMAKE_BUILD_TYPE=Release $(CMAKE_FLAGS) -DUSE_OPEN_OCD:BOOL=$(USE_OPEN_OCD)  -DUSE_LIBFTDISPI:BOOL=ON -DBUILD_UT:BOOL=$(BUILD_UT)
