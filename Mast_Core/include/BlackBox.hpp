...
//! @file BlackBox.hpp
//!
//! Declares class BlackBox
//!
//===========================================================================

#ifndef BLACKBOX_H__AC94642C_6C5D_4241_B69A_C5DE634D3EAA__INCLUDED_
  #define BLACKBOX_H__AC94642C_6C5D_4241_B69A_C5DE634D3EAA__INCLUDED_
...
//!
class BlackBox : public SystemModelNode, public RegisterInterface
{
  // ---------------- Public  Methods
  //
  public:
  ~BlackBox() = default;
  BlackBox()  = delete;
  BlackBox(std::experimental::string_view name,
  ...
  virtual std::experimental::string_view TypeName()    const override { return "BlackBox";    } //!< Returns readable type name
  ...
  bool                IsPendingForRead()  const { return m_pendingRead;        } //!< Returns true when there is a pending request to read the BlackBox from SUT
  ...
  uint32_t            BitsCount()         const override { return m_bypass.BitsCount(); } //!< Returns BlackBox numbers of bits
...
//
//  End of BlackBox class declaration
//---------------------------------------------------------------------------
...
#endif  // not defined BLACKBOX_H__AC94642C_6C5D_4241_B69A_C5DE634D3EAA__INCLUDED_
