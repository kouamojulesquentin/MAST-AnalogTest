...
void UT_GmlPrinterVisitor::test_VisitAccessInterface_with_Child ()
{
  ...
  auto expected = string("graph\n"
                         ...
                         "   node [ id 7 graphics [ type \"trapezoid\" fill \"#FF3060\" w 144 h 43 ] LabelGraphics [ text \"Linker name\" fontSize 13 fontStyle \"bold\" fontName \"Lucida Console\"] ]\n"
...
void UT_GmlPrinterVisitor::test_Visit_With_DisplayIdentifierAndRegister_true ()
{
  ...
  auto expected = string("graph\n"
                         ...
                         "   node [ id 0 graphics [ type \"octagon\" fill \"#10FFFF\" w 135 h 43 ] LabelGraphics [ text \"(0)\n"
                         "1149_1_TAP\" fontSize 13 fontStyle \"bold\" fontName \"Lucida Console\"] ]\n"
                         "   node [ id 1 graphics [ type \"rectangle\" fill \"#59FF20\" w 171 h 126 ] LabelGraphics [ text \"(1)\n"
                         "TAP_IR\n"
                         "Width: 6\n"
                         "Bypass:    1111_11\n"
                         "Next to:   1111_11\n"
