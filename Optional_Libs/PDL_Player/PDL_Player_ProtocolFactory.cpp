//===========================================================================
//                           PDL_Player_ProtocolFactory.cpp
//===========================================================================
// Copyright (C) 2020 G-INP/Tima. All rights reserved.
//
// Project : Mast
//
//! @file PDL_Player_ProtocolFactory.cpp
//!
//! Implements class PDL_Player_EmulationProtocol
//!
//===========================================================================
...
namespace
{
  ...
  bool AccessInterfaceTranslatorProtocolFactory ()
  {
    ...
    auto  factory  = [](const string& /* parameters */)  { return std::make_unique<PDL_Player_TranslatorProtocol>(); };


   repo.RegisterCreator("PDL_Player", factory);
...
//===========================================================================
// End of PDL_PlayerProtocolFactory.cpp
//===========================================================================
