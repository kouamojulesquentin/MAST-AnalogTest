//===========================================================================
//                           FTDI_ProtocolFactory.cpp
//===========================================================================
// Copyright (C) 2020 G-INP/Tima. All rights reserved.
//
// Project : Mast
//
//! @file FTDI_ProtocolFactory.cpp
//!
//! Implements class FTDI_EmulationProtocol
//!
//===========================================================================
...
namespace
{
  ...
  bool AccessInterfaceTranslatorProtocolFactory ()
  {
    ...
    auto  factory  = [](const string& /* parameters */)  { return std::make_unique<FTDI_TranslatorProtocol>(); };


   repo.RegisterCreator("FTDI", factory);
...
//===========================================================================
// End of FTDIProtocolFactory.cpp
//===========================================================================
