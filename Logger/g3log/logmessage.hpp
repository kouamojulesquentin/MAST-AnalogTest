...
namespace g3 {
   ...
   * desired way.
   */
   struct G3LOG_DLL_EXPORT LogMessage
   {
      ...
      LEVELS              _level;
      int                 _depth = 0;       // Usually equal to call depth but can also be used to visually identify a block of code
      ...
      private:
      thread_local static int sm_threadDepth; // Call depth associate to thread (may be used to identify just a block logs inside a function)
   }; // End of LogMessage
