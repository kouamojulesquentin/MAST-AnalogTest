...
class UT_PDL_Adapter : public CxxTest::TestSuite
{
  ...
  // ---------------- iGet_xx
  //
//+  void test_iGet_BinaryVector_NotInitialized ();
...
//+  void test_iGet_BinaryVector_Nullptr_Path ();
...
//+  void test_iGet_BinaryVector_Nullptr_ReadData ();
