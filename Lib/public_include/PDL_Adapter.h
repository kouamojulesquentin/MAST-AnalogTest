...
extern "C"
{
  ...
  // ---------------- iGet
  //
//+  DLL_EXPORT ErrorCode iGet_BinaryVector (const char* registerPath, char* readDataBuffer, size_t* readDataBufferLength); //!< Returns last Register value read from SUT as binary string
