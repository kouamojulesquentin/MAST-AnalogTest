//===========================================================================
//                           MSPG_ProtocolFactory.cpp
//===========================================================================
// Copyright (C) 2020 G-INP/Tima. All rights reserved.
//
// Project : Mast
//
//! @file MSPG_ProtocolFactory.cpp
//!
//! Implements class MSPG_EmulationProtocol
//!
//===========================================================================
...
namespace
{
  ...
  bool AccessInterfaceTranslatorProtocolFactory ()
  {
    ...
    auto  factory  = [](const string& /* parameters */)  { return std::make_unique<MSPG_TranslatorProtocol>(); };


   repo.RegisterCreator("MSPG", factory);
