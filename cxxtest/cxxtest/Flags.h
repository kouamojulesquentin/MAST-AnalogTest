...
// ---------------- Default constants for aborting (or not) data driven tests
//
#if defined(_CXXTEST_ABORT_DDT_ON_FAIL) && !defined(CXXTEST_DEFAULT_DDT_ABORT)
#   define CXXTEST_DEFAULT_DDT_ABORT true
#endif // _CXXTEST_ABORT_DDT_ON_FAIL && !CXXTEST_DEFAULT_DDT_ABORT

#if !defined(CXXTEST_DEFAULT_DDT_ABORT)
#   define CXXTEST_DEFAULT_DDT_ABORT false
#endif // !CXXTEST_DEFAULT_DDT_ABORT
