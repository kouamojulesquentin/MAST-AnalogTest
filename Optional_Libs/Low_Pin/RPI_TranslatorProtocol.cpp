...
// Project : Mast
//
//! @file RPI_TranslatorProtocol.cpp
//!
//! Implements class RPI_TranslatorProtocol, which can be used as a model
...
//!
RPI_TranslatorProtocol::RPI_TranslatorProtocol ()
{
}
//
//  End of: RPI_TranslatorProtocol::RPI_TranslatorProtocol
//---------------------------------------------------------------------------


BinaryVector RPI_TranslatorProtocol::TransformationCallback(RVFRequest current_request) 
{
...
//
//  End of: RPI_TranslatorProtocol::TransformationCallback
//---------------------------------------------------------------------------


//===========================================================================
// End of RPI_TranslatorProtocol.cpp
//===========================================================================
