//===========================================================================
//                           AnalogPort_EmulationProtocol.cpp
//===========================================================================
// Copyright (C) 2016 G-INP/Tima. All rights reserved.
//
// Project : Mast
//
//! @file AnalogPort_ProtocolFactory.cpp
//!
//! Implements class AnalogPort_EmulationProtocol
//!
//===========================================================================
...
namespace
{
  ...
  bool RegisterAccessInterfaceProtocolFactory ()
  {
    ...
    auto  factory  = [](const string& PortName) { return std::make_unique<AnalogPort_Protocol>(PortName); };

    repo.RegisterCreator("AnalogPort", factory);
...
//===========================================================================
// End of AnalogPortProtocolFactory.cpp
//===========================================================================
